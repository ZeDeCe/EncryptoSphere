...
class DropBox(CloudService):
    ...
    def authenticate_cloud(self):
        """
        Authenticate the Dropbox account and get access token.
        The function receives an email address to authenticate to and verifies the authentication.
        It also creates and saves the root folder (if not already existing).
        """
        ...
        if not self.authenticated:
            print("DropBox : No valid token found, starting authentication...")
        ...
        try:
            ...
            print("DropBox : Root folder ready.")
        except Exception as e:
            print(f"DropBox : Error creating root folder: {e}")
            return False
