...
class Gateway:
    ...
    def authenticate(self, email):
        ...
        self.manager.clouds[0].upload_file(b"HELLO WORLD1", "1", "/EncryptoSphere")
        self.manager.clouds[0].upload_file(b"HELLO WORLD2", "2", "/EncryptoSphere")
        self.manager.clouds[0].upload_file(b"HELLO WORLD3", "3", "/EncryptoSphere")
        a = self.manager.clouds[0].list_files("/EncryptoSphere")
        print (a)
        print("\n")
        b = self.manager.clouds[0].upload_file(b"HELLO WORLD", "TEST", "/EncryptoSphere")
        print(b)
        print("\n")
        c = self.manager.clouds[0].upload_file(b"HELLO WORLD", "TEST2", "/EncryptoSphere")
        print(c)
        print("\n")
        d = self.manager.clouds[0].download_file("T", "/EncryptoSphere")
        print(d)
        print("\n")
        e = self.manager.clouds[0].delete_file("TEST", "/EncryptoSphere")
        print(e)
        print("\n")
        f = self.manager.clouds[0].get_folder("/EncryptoSphere")
        print(f)
        print("\n")
        g = self.manager.clouds[0].get_folder_path("/EncryptoSphere")
        print(g)
        print("\n")
        h = self.manager.clouds[0].create_folder("/EncryptoSphere/TEST_FOLDER")
        print(h)
        print("\n")
